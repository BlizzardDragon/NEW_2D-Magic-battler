...
namespace VampireSquid.Common.CompositeRoot
{
    ...
    {
        public List<CompositionBase> Compositions = new();
        ...
        public void CreateComposition<T>() where T : CompositionBase, new() => Compositions.Add(new T());
        ...
        {
            var find = FindAnyObjectByType<TDependency>(includeInactive ? FindObjectsInactive.Include : FindObjectsInactive.Exclude);
